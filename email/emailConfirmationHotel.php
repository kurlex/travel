...
if( isset($_POST['submit']) &&  isset($_POST['firstName']) &&  isset($_POST['surname']) &&  isset($_POST['email']) &&  isset($_POST['cemail']) &&  isset($_POST['ids']) && isset($_POST['cost']) && isset($_POST['infant'])&& isset($_POST['child']) && isset($_POST['adult']) ){
    ...
    $sql = "select * from preReservationHotel where preReservationID = '" . $key ."' AND date = \"".date("Y-m-d")."\"";
    ...
    $sql = "
    insert into preReservationHotel 
    (preReservationID , cost , adult , child , infant , hotelID , date , ip_addr , lastName , firstName , email) VALUES
